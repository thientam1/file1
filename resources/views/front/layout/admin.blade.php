...
<head>
    ...
    <link rel="stylesheet" href="front/admin/assets/css/styles.min.css" />
</head>
...
<body>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="./ui-alerts.html" aria-expanded="false">
                                ...
                                <span class="hide-menu">Quest</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('blog_add')}}" aria-expanded="false">
                                <span>
                        ...
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="front/admin/assets/images/profile/user-1.jpg" alt="" width="35" height="35" class="rounded-circle">
                                </a>
    ...
    <script src="front/admin/assets/libs/jquery/dist/jquery.min.js"></script>
    <script src="front/admin/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    <script src="front/admin/assets/js/sidebarmenu.js"></script>
    <script src="front/admin/assets/js/app.min.js"></script>
    <script src="front/admin/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
    <script src="front/admin/assets/libs/simplebar/dist/simplebar.js"></script>
    <script src="front/admin/assets/js/dashboard.js"></script>
</body>
